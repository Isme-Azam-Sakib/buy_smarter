...
import VendorApplicationSection from '@/components/features/VendorApplicationSection'
import Footer from '@/components/ui/Footer'

const FEATURED_CATEGORIES = ['processor', 'graphics-card', 'ram', 'ssd', 'motherboard']
  ...
  return (
    <main className="min-h-screen">
      ...
      {FEATURED_CATEGORIES.map((category) => (
        <CategoryShowcase key={category} categoryId={category} />
      ))}
