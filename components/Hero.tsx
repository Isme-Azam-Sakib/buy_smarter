...
export default function Hero() {
  ...
  const features = [
    {
      icon: TrendingDown,
      title: 'Find Cheapest Prices',
      description: 'Compare prices across 6+ major retailers in Bangladesh'
    },
    {
      icon: Wrench,
      title: 'PC Builder',
      description: 'Build your dream PC with compatibility checking'
    },
    {
      icon: BarChart3,
      title: 'Smart Recommendations',
      description: 'AI-powered suggestions for optimal builds'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Find the <span className="text-primary-600">Cheapest</span> PC Parts
            <br />
            in Bangladesh
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Compare prices from Star Tech, Ryans, TechLand BD, and more. 
            Build your perfect PC with our AI-powered recommendations.
          </p>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search for CPU, GPU, RAM, Motherboard..."
                value={searchQuery}
